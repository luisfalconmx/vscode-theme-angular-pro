<!-- START README_TEMPLATE/vscode-theme.template.md -->
...
<p align="center">
  <img src="https://raw.githubusercontent.com/luisfalconmx/vscode-theme-angular-pro/main/.github/screenshot.png" alt="Vscode Theme Angular Pro" width="100%" />
</p>
...
```bash
# HTTPS
https://github.com/luisfalconmx/vscode-theme-angular-pro.git
```

```bash
# SSH
git@github.com:luisfalconmx/vscode-theme-angular-pro.git
```

```bash
# GITHUB CLI
gh repo clone luisfalconmx/vscode-theme-angular-pro
```
...
We use GitHub Discussions to talk about all sorts of topics related to documentation and this site. For example: if you'd like to help troubleshooting a PR, have a great new idea, or want to share something amazing you've learned in our docs, join us in the [discussions](https://github.com/luisfalconmx/vscode-theme-angular-pro/discussions).

## Roadmap

Our project roadmap is where you can learn about what features we're working on, what stage they're in, and when we expect to bring them to you. Have any questions or comments about items on the roadmap? Share your feedback in [discussions](https://github.com/luisfalconmx/vscode-theme-angular-pro/discussions) section.

Review the project roadmap. Maybe there is something amazing that you can contribute 😉

[https://github.com/luisfalconmx/vscode-theme-angular-pro/projects?type=beta](https://github.com/luisfalconmx/vscode-theme-angular-pro/projects?type=beta)
...
[https://github.com/luisfalconmx/vscode-theme-angular-pro/releases](https://github.com/luisfalconmx/vscode-theme-angular-pro/releases)
...
[https://github.com/luisfalconmx/vscode-theme-angular-pro/deployments](https://github.com/luisfalconmx/vscode-theme-angular-pro/deployments)

For better understand, it is advisable to follow the instructions detailed in [contributing](https://github.com/luisfalconmx/vscode-theme-angular-pro#contributing) section.
...
<!-- END README_TEMPLATE/vscode-theme.template.md -->
